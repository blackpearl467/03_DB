...
SELECT ROUND(123.456) FROM DUAL; -- 123 소수점 첫번째자리에서 반올림

SELECT ROUND(123.456, 1) FROM DUAL; 
--123.5 소수점 두번째자리에서 반올림(소수점 첫번째자리까지 표기)

SELECT ROUND(123.456, 0) FROM DUAL; -- 소수점 첫번째자리에서 반올림
...
-- SUM(숫자가 기록된 컬럼명) : 합계
-- 모든 직원의 급여 합 조회
SELECT SUM(SALARY) "모든 직원의 급여 합"
FROM EMPLOYEE; -- 70,096,240

-- AVG(숫자가 기록된 컬럼명) : 평균
-- 전 직원 급여 평균
SELECT ROUND(AVG(SALARY)) "전 직원 급여 평균"
