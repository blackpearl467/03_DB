...
--2.컬럼에 주석 달기
--[표현식]
--COMMNET IN COLUMN 테이블명.컬럼명 IS '주석내용';
...
('MEM01', '123ABC', '홍길동', '991234-1234567', DEFAULT);
...
-- 가입일 -> SYSDATE로 삽입
INSERT INTO "MEMBER" VALUES
('MEM02', 'QWER1234', '김차차', '009876-9876543', SYSDATE);
...
INSERT INTO "MEMBER" VALUES
('MEM04', 'PASS04', '김길동', '931201-4545456',
TO_DATE('2024-10-17 13:33:33', 'YYYY-MM-DD HH24:MI:SS')
);
...
--NULL을 ("KH_KBG"."USER_USED_NN"."USER_NO") 안에 삽입할 수 없습니다
...
--무결성 제약 조건(KH_KBG.USER_ID_U)에 위배됩니다
...
INSERT INTO USER_USED_UK2
VALUES (2, 'USER01', 'PASS01', '고길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');

INSERT INTO USER_USED_UK2
VALUES (1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
--SQL Error [1] [23000]: ORA-00001: 무결성 제약 조건(KH_KBG.USER_ID_NAME_U)에 위배됩니다
...
--한테이블당 한개만 설정할 수 있음
--컬럼레벨, 테이블레벨 둘다 설정 가능
--한개 컬럼에 설정할 수 있고, 여러개의 컬럼을 묶어서 설정할 수 있음(== PRIMARY 복합키)
...
INSERT INTO USER_USED_PK
VALUES (1, 'USER02', 'PASS02', '바보야', '여자', '010-5555-5555', 'BABO55@kh.or.kr');
--기본키 중복 오류!
--SQL Error [1] [23000]: ORA-00001: 무결성 제약 조건(KH_KBG.USER_NO_PK)에 위배됩니다

INSERT INTO USER_USED_PK
VALUES (NULL, 'USER03', 'PASS03', '멍청이', '여자', '010-7777-7777', '77MONG@kh.or.kr');
--기본키 NULL이므로 오류!
--SQL Error [1400] [23000]: ORA-01400: NULL을 ("KH_KBG"."USER_USED_PK"."USER_NO") 안에 삽입할 수 없습니다

INSERT INTO USER_USED_PK
VALUES (2, 'USER03', 'PASS03', '멍청이', '여자', '010-7777-7777', '77MONG@kh.or.kr');
...
INSERT INTO USER_USED_PK2
VALUES (1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
--SQL Error [1] [23000]: ORA-00001: 무결성 제약 조건(KH_KBG.PK_USERNO_USERID)에 위배됩니다
--USER_NO, USER_ID 둘다 중복되었을때만 제약조건 위배 에러 발생!


INSERT INTO USER_USED_PK2
VALUES (NULL, 'USER03', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
--SQL Error [1400] [23000]: ORA-01400: NULL을 ("KH_KBG"."USER_USED_PK2"."USER_NO") 안에 삽입할 수 없습니다

INSERT INTO USER_USED_PK2
VALUES (3, NULL, 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
--SQL Error [1400] [23000]: ORA-01400: NULL을 ("KH_KBG"."USER_USED_PK2"."USER_ID") 안에 삽입할 수 없습니다
...
INSERT INTO USER_USED_FK
VALUES (2, 'USER02', 'PASS02', '이순신', '남자', '010-5555-5555', 'lee123@kh.or.kr', 10);
-- USER_GRADE (부모테이블/참조테이블)에 10이라는 GRADE_CODE가 존재하므로 가능

INSERT INTO USER_USED_FK
VALUES (3, 'USER03', 'PASS03', '유관순', '여자', '010-9999-9999', 'yoo123@kh.or.kr', 30);
-- USER_GRADE (부모테이블/참조테이블)에 30이라는 GRADE_CODE가 존재하므로 가능

INSERT INTO USER_USED_FK
VALUES (4, 'USER04', 'PASS04', '안중근', '남자', '010-0000-0000', 'ahn123@kh.or.kr', null);
--> NULL 사용가능

INSERT INTO USER_USED_FK
VALUES (5, 'USER05', 'PASS05', '윤봉길', '남자', '010-1111-1111', 'yoon123@kh.or.kr', 50);
...
--GRADE_CODE중 20은 외래키로 참조되고 있지않으므로 삭제가 가능함.
...
CREATE TABLE USER_USED_FK2(
	...
	PHONE VARCHAR2(30),
	EMAIL VARCHAR2(50),
	GRADE_CODE NUMBER CONSTRAINT GRADE_CODE_FK REFERENCES USER_GRADE2 ON DELETE SET NULL
																		/* 삭제옵션 */
);
...
SELECT * FROM USER_USED_FK2; --10을 사용하고있던 자식 레코드값이 NULL이 됨을 확인

--3)ON DELETE CASCADE: 부모키 삭제시 자식키도 함께 삭제됨
-- 부모키 삭제시 값을 사용하고있던 자식테이블의 컬럼에 해당하는 행이 삭제됨
...
--> ON DELETE CASCADE 옵션이 설정되어있어서 오류 없이 삭제됨
...
VALUES (1, 'USER01', 'PASS01', '홍길동', '남자', '010-1234-5678', 'hong123@kh.or.kr');
--SQL Error [2290] [23000]: ORA-02290: 체크 제약조건(KH_KBG.GENDER_CHECK)이 위배되었습니다
...
-->이외의 값이 들어오면 체크 제양조건 위배되어 에러 발생!!