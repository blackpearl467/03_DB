...
--> 예전 SQL방식 허용 (계정명을 간단히 작성가능)

--[작성법]
--CREATE USER 사용자명 IDENTIFIED BY 비밀번호;
CREATE USER kbg_sample IDENTIFIED BY 1234;
...
--[권한 부여 작성법]
--GRANT 권한, 권한,... TO 사용자명;
GRANT CREATE SESSION TO kbg_sample;
...
GRANT CREATE TABLE TO kbg_sample;

ALTER USER kbg_sample DEFAULT TABLESPACE SYSTEM QUOTA UNLIMITED ON SYSTEM;
...
--(SYS) SAMPLE계정에 CONNECT, RESOURCE ROLE 부여
GRANT CONNECT, RESOURCE TO kbg_sample;
