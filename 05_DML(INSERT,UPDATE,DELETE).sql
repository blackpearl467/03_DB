...
--테이블에 있는 모든 컬럼에 대한 값을 INSERT 할때 사용
--INSERT 하고자 하는 컬럼이 모든 컬럼인 경우 컬럼명 생략 가능
--단, 컬럼의 순서를 지켜서 VALUES에 값을 기입해야함
INSERT INTO EMPLOYEE2;

INSERT INTO EMPLOYEE2
VALUES('900', '김냥냥', '990615-291773', 'catkim@or.kr', '01011112222', 'D1'
	'J7', 'S4', 4300000, 0.2, 200, SYSDATE, NULL, 'N');
SELECT  * FROM EMPLOYEE2
WHERE EMP_ID = '900';
ROLLBACK;

--2)INSERT INTO 테이블명(컬럼명1, 컬럼명, 컬럼명 ...)
--				VALUES  (데이터1, 데이터, 데이터 ...);
...
INSERT INTO EMPLOYEE2(EMP_ID, EMP_NAME, EMP_NO, EMAIL, PHONE,
				...
				VALUES('900', '김냥냥', '990615-291773', 'catkim@or.kr', 
				'01011112222', 'D1', 'J7', 'S4', 4300000);
SELECT * FROM EMPLOYEE2
WHERE EMP_ID = 900;
...
CREATE TABLE EMP_01(
	EMP_ID NUMBER,
	EMP_NAME VARCHAR2(30), --문자열
	DEPT_TITLE VARCHAR2(20) --문자열
);
SELECT * FROM EMP_01; --원래비어있었음
...
UPDATE EMPLOYEE2
SET BONUS = 0.1
WHERE BONUS IS NULL; --BONUS='NULL' 이 아님
...
DEPT_ID = 'D0',
DEPT_TITLE = '전략기획팀' --WHERE 절 직전 컬럼 작성 콤마X
WHERE DEPT_ID = 'D9'
AND DEPT_TITLE = '총무부';
...
SELECT * FROM EMPLOYEE3; --롤백 후 복구 확인 (복구 안됨을 확인!)
